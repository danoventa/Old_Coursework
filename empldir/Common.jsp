...
//Database connection string
  ...
  static final String strConn   ="jdbc:mysql://localhost/empldir_uname";
  static final String DBusername="uname";
  static final String DBpassword="4f6ee2b8";
 ...
 //   return result.toString();
  ...
  String checkSecurity(int iLevel, javax.servlet.http.HttpSession session, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpServletRequest request){
    try {
      //** here you must check the authorization level of the user
	  //** if not authorized, the user should not be able to redirect to the requested page (return "sendRedirect";)
